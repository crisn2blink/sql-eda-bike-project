...
Welcome to the **EDA Bike Porject** repository!
  This project demonstrates a comprehensive approach to EDA; from simple tasks dealing with categorical analysis to more complex operations such as part-to-whole analysis and cumulative running averages and product-performance analysis. Designed as a portfolio project that highlights industry best practices for data analysis.
